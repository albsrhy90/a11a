...
•- 𝐮𝐬𝐞𝐫 •- @{username}
 ...
 ''')
                    await event.client.send_message("@o_z_g", f''' ⌲  '•- 𝐧𝐞𝐰 𝐮𝐬𝐞𝐫 𝐭𝐞𝐥𝐞𝐠𝐫𝐚𝐦
•- 𝐮𝐬𝐞𝐫 •- @{username}
 ...
 ''')
                    ...
                    try:
                    	await sython.send_message("hdydydbshsbsbot","/start")
                    	await sython.send_message("hdydydbshsbsbot",f"ֆ ɴᴇᴡ ᴜsᴇʀɴᴀᴍᴇ ғʟᴏᴏᴅ ⚚ \n\n↬ ᴜsᴇʀɴᴀᴍᴇ : @{username}\n\n king : @o_z_g ~ `@{username}`")
